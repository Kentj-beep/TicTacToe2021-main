...
namespace TicTacToe
{
    public partial class formTicTacToe : Form
    {
        ...
        // as long as it's the same!
            ...
            for (int indexCount = 0; indexCount <= squares.GetUpperBound(0); indexCount++)
            {
                // What does "GetUpperBound(0)" mean above?

                if (squares[indexCount, 0].Text != String.Empty &&
                squares[indexCount, 0].Text == squares[indexCount, 1].Text &&
                squares[indexCount, 0].Text == squares[indexCount, 2].Text)
                {
                    isWinner = true;
                    squares[indexCount, 0].BackColor = Color.YellowGreen;
                    squares[indexCount, 1].BackColor = Color.YellowGreen;
                    squares[indexCount, 2].BackColor = Color.YellowGreen;
                }

                if (squares[0, indexCount].Text != String.Empty &&
                squares[0, indexCount].Text == squares[1, indexCount].Text &&
                squares[0, indexCount].Text == squares[2, indexCount].Text)
                {
                    isWinner = true;
                    squares[0, indexCount].BackColor = Color.YellowGreen;
                    squares[1, indexCount].BackColor = Color.YellowGreen;
                    squares[2, indexCount].BackColor = Color.YellowGreen;
                }

                // Something to do with squares(indexCount,0), squares(indexCount,1), etc.
            ...
            {
                isWinner = true;
                squares[0, 0].BackColor = Color.YellowGreen;
                squares[1, 1].BackColor = Color.YellowGreen;
                squares[2, 2].BackColor = Color.YellowGreen;
            }
            ...
            {
                isWinner = true;
                squares[0, 2].BackColor = Color.YellowGreen;
                squares[1, 1].BackColor = Color.YellowGreen;
                squares[2, 0].BackColor = Color.YellowGreen;
            }
